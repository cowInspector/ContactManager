...
public class AddContactEventHandler implements ActionListener {
	...
	private void bundleContactData() {
		...
		contactDetailsData.add(AddContactPanel.formattedTextFieldDateMet.getText());
	}
	...
	private void buildEmailDetailVector() {
		...
		emailRowData.add(AddContactPanel.comboBoxEmailType.getSelectedItem().toString());
	...
	private void buildAddressDetailVector() {
		...
		addrRowData.add(AddContactPanel.comboBoxAddrType.getSelectedItem().toString());
	...
	private void buildPhoneNumberVector() {
		...
		phoneDetailsData.add(AddContactPanel.comboBoxPhType.getSelectedItem().toString());
